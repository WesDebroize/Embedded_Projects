...
*/
/*
  You can create almost everycolour using the RBG LED by using the
  analogue output to adjust how much power goes through each colour
  (Remember - range from 0-255)
*/